...
```mermaid
graph TD
    A1[Prospecção Suporte: Lentidão/Pane de Máquinas] --> B1[Abordagem A: Diagnóstico Rápido de Risco]
    A2[Prospecção Web/Design: Clínicas/Escritórios sem site] --> B2[Abordagem B: Combo Site + Logomarca + Posicionamento]
    A3[Prospecção Educação: Aulas e Treinamentos IA/LGPD] --> B3[Abordagem C: Workshops de Produtividade com IA e LGPD]
    B1 --> C[Execução de Serviços e Venda de Contrato Recorrente]
    B2 --> C
    B3 --> C
```
